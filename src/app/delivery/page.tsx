      ...
      <main className="flex-1 bg-background py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-surface p-8 rounded-xl border border-border shadow-sm space-y-6 text-text-light leading-relaxed">
            ...
            <h3 className="font-semibold text-lg text-text-main mt-4">Inside Dhaka</h3>
            <p>Orders placed before 2 PM are eligible for same-day delivery. Standard delivery takes 24 hours.</p>
            <h3 className="font-semibold text-lg text-text-main mt-4">Outside Dhaka</h3>
            <p>Deliveries outside Dhaka are handled by third-party logistics and typically take 2-4 business days.</p>
            <h3 className="font-semibold text-lg text-text-main mt-4">Delivery Charges</h3>
