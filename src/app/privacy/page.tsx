...
const defaultContent = `
            ...
            <h3 class="font-semibold text-lg text-text-main mt-4">Information We Collect</h3>
            ...
            <h3 class="font-semibold text-lg text-text-main mt-4">How We Use Your Information</h3>
            ...
            <h3 class="font-semibold text-lg text-text-main mt-4">Security</h3>
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1 bg-background py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <EditablePageContent slug="privacy" defaultHtmlContent={defaultContent} />
        </div>
      </main>
      <Footer />
    </div>
