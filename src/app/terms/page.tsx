...
const defaultContent = `
            ...
            <h3 class="font-semibold text-lg text-text-main mt-4">General Terms</h3>
            ...
            <h3 class="font-semibold text-lg text-text-main mt-4">Pricing and Availability</h3>
            <p>All prices are subject to change without notice. We reserve the right to modify or discontinue products at any time.</p>
            <h3 class="font-semibold text-lg text-text-main mt-4">Prohibited Uses</h3>
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1 bg-background py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <EditablePageContent slug="terms" defaultHtmlContent={defaultContent} />
        </div>
      </main>
      <Footer />
    </div>
